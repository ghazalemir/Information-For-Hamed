...
#This is the most time consuming function, it is possible to bypass it and ignore the path inside the reactor
...
#Count calculation using MonteCarlo
Count=count([0.15,0,0.1],[0.17,0,0.1])


#Efficiency calculation using MonteCarlo
EPS=solid_angle([0.15,0,0.1],[0.17,0,0.1])



#uncomment to Write in excel file
"""
Count_num=pd.DataFrame(Count)     
Count_num = Count_num.copy()
Count_num.to_csv('Result.csv') 
"""

#Uncoment to write in excel file
"""
EPS_num=pd.DataFrame(Count)     
EPS_num = EPS_num.copy()
EPS_num.to_csv('Result.csv') 
"""
